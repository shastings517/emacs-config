...
- =e= - enter iedit from expand-region state
- =TAB= - toggle current occurrence
- =0= - go to beginning of occurrence
- =$= - go to end of the current occurrence
...
- =J= - increase edit scope by one line below
- =K= - increase edit scope by one line below
- =L= - restrict edit scope to current line
- =n= - go to next occurrence
- =N= - go to previous occurrence
- =p= - replace occurences with last yanked text
- =S= - (substitute) delete the occurrences and switch to iedit-insert state
- =V= - toggle visibility of lines with no occurrences
- =U= - up-case occurences
- =C-U= - down-case occurrences
...
- =S<textobject> OR gS<textobject>= - surround in visual-state
- =ys<textobject> OR yS<textobject>= - surround in normal-state
- =cs<old-textobject><new-textobject>= - change surrounding textobject
- =ds<textobject>= - delete surrounding textobject
